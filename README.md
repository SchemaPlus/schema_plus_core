...
* ruby **2.6.8** with activerecord **5.2**, using **mysql2**, **sqlite3** or **postgresql**
* ruby **2.6.8** with activerecord **6.0**, using **mysql2**, **sqlite3** or **postgresql**
* ruby **2.6.8** with activerecord **6.1**, using **mysql2**, **sqlite3** or **postgresql**
* ruby **2.7.5** with activerecord **5.2**, using **mysql2**, **sqlite3** or **postgresql**
* ruby **2.7.5** with activerecord **6.0**, using **mysql2**, **sqlite3** or **postgresql**
* ruby **2.7.5** with activerecord **6.1**, using **mysql2**, **sqlite3** or **postgresql**
